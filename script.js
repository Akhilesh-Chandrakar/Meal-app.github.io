            ...
            data.meals.forEach((element) => {
                ...
                <div id="card" class="card mb-3" style="width: 20rem;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            ...
                            <button id="main${element.idMeal}" class="btn btn-outline-light active" onclick="addRemoveToFavList(${element.idMeal})" style="border-radius:50%">Remove from Favourites</button>
                        </div>
                    </div>
                </div>
                `;
                ...
                <div id="card" class="card mb-3" style="width: 20rem;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            <button type="button" class="btn btn-outline-light" onclick="showMealDetails(${element.idMeal})">More Details</button>
                            <button id="main${element.idMeal}" class="btn btn-outline-light" onclick="addRemoveToFavList(${element.idMeal})" style="border-radius:50%; margin:10px;">Add to Favourites</button>
                        </div>
                    </div>
                </div>
                `;
            ...
            await fetchMealsFromApi(url,arr[index]).then(data=>{
                ...
                <div id="card" class="card mb-3" style="width: 20rem;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mt-5 mr-10">
                            <button type="button" class="btn btn-outline-light mr-20" onclick="showMealDetails(${data.meals[0].idMeal})">More Details</button>
                            <button id="main${data.meals[0].idMeal}" class="btn btn-outline-light active " onclick="addRemoveToFavList(${data.meals[0].idMeal})" style="border-radius:50%">Remove from Favourites</button>
                        </div>
                    </div>
                </div>
                `;
